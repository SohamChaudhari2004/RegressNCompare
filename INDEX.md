...
**A comprehensive Streamlit web application for machine learning education and model comparison**
...
│   ├── USAGE_EXAMPLES.md       # 18 comprehensive examples
...
- Example 17: Downloading and using models
...
3. Explore: Click around the app (2 min)
```
...
3. Tutorial: Follow USAGE_EXAMPLES.md Example 1 (5 min)
4. Experiment: Try your own dataset (9 min)
```
...
3. Basics: Run Examples 1-6 from USAGE_EXAMPLES.md (30 min)
4. Deep Dive: Read app.py code (30 min)
5. Advanced: Run Examples 7-18 (30 min)
```
...
- **Day 4**: Practice interpreting visualizations
...
- **Day 4**: Experiment with test sizes
...
- **Day 4**: Implement suggested enhancements
...
4. **INSTALLATION.md** - Student setup guide
...
- Overfitting detection (README.md, USAGE_EXAMPLES.md)
- Feature importance (USAGE_EXAMPLES.md)
...
build_pipelines()        # Model pipeline creation
train_and_evaluate()     # Training and metrics
plot_comparison()        # Comparison charts
plot_feature_importance() # Feature importance viz
plot_predictions()       # Scatter plots
plot_residuals()         # Residual analysis
plot_partial_dependence() # PDP plots
```
...
4. ✅ Try uploading sample_data.csv
...
- [ ] Verified installation: `streamlit --version`
